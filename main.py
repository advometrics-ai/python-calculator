...
bplus=customtkinter.CTkButton(root,text='+',font=('arial',20,'bold'),width=60,bg_color='black',cursor='hand2',fg_color='orange3',command=lambda :click('+'))
...
bminus=customtkinter.CTkButton(root,text='-',font=('arial',20,'bold'),width=60,bg_color='black',cursor='hand2',fg_color='orange3',command=lambda :click('-'))
...
bmultiply=customtkinter.CTkButton(root,text='*',font=('arial',20,'bold'),width=60,bg_color='black',cursor='hand2',fg_color='orange3',command=lambda :click('*'))
...
bdivision=customtkinter.CTkButton(root,text='/',font=('arial',20,'bold'),width=60,bg_color='black',cursor='hand2',fg_color='orange3',command=lambda :click('/'))
bdivision.grid(row=4,column=3)

bequal=customtkinter.CTkButton(root,text='=',font=('arial',20,'bold'),width=280,bg_color='black',cursor='hand2',fg_color='dark green',command=lambda :click('='))
